...
export default (props) => <ArticleLayout meta={meta} {...props} />
 ...
 Nous développons avec la maison dédition La Volte un outil décriture collaborative qui permet d’écrire des variations et des prolongements de récits à plusieurs mains. Cet outil reprend les mêmes principes (et une partie de la technologie) qu’un outil bien connu des développeurs : git. 
Voici un premier article où nous explorons **la gestion de l'historique dun texte.**
...
<Image src={gif} alt="gif signal-desktop" />
